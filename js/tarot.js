var tarots = [
  ...
  ["The Heart", "coeur", "This word refers to all kinds of movements and desires, but what is constant is that the theyart is constituted into a gift-abject-whether ignored or rejected. "],
  ...
  ["Gossip", "potin", "Pain suffered by the amorolls subject when they finds that the loved being is the subject of 'gossip' and theyars that being discussed promiscuosly."],
  ...
  ["Sobria Ebrietas", "vouloir-saisir", "Realizing that the difficulties of the amorous relationship originate in their ceaseless desire to appropriate the loved being in one way or another, the subject decides to abandon theynceforth all 'will-to-possess' in their regard."]
]
